...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // Cho phép sử dụng @PreAuthorize,... trên controller/service
@RequiredArgsConstructor
public class SecurityConfig {

    private final JwtAuthenticationFilter jwtAuthenticationFilter;
    private final UserDetailsService userDetailsService; // Service để load UserDetails
    private final CustomAuthenticationSuccessHandler customSuccessHandler; // Handler sau khi login thành công
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/delivery/**").hasRole("DELIVERY") // <<<--- ĐÃ THÊM DÒNG NÀY
