...
// Không phụ thuộc vào service của module khác
...
public class DeliveryController {
    ...
    // Bỏ phụ thuộc OrderServiceImpl để tách biệt module delivery
    ...
    public String changePassword(
     ...
     public String originalOrderDetail(@PathVariable Integer orderId, Authentication authentication, Model model) {
         try {
            ...
            DeliveryOrderDetailDTO orderDetailDTO = deliveryService.getOrderDetailByOrderId(authentication, orderId);
